<?php
    ...
    $conn = new AboutController();
   
    // Searching of Product
    if(isset($_REQUEST['search'])) {
        $record = $conn->fetch_search_products($_REQUEST);
    } else if($conn) {
        $record = $conn->fetch_products();
    }
    ...
    if(!empty($_REQUEST['add_to_cart'])) {
        ...
        if(isset($_SESSION['user_id'])) { 
            ...
            echo "<script>location.href='add_to_cart.php?pageName=about&productId=$productid&size=$size&quantity=$quantity&userId=$userId'</script>";
        } 
        else {
...
?>
    <div id="carouselExampleControls" class="carousel slide carousel-fade mt-5" data-bs-ride="carousel" data-bs-interval="2000">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="../slider/1.png" class="d-block w-100 object-fit" height="520px" alt="Men_Poster">
            </div>
            <div class="carousel-item">
                <img src="../slider/2.png" class="d-block w-100" height="520px" alt="women_Image_Poster">
            </div>
            <div class="carousel-item">
    ...
    <div class="container-fluid"> 
        <!-- Random 8 Products Show -->
        <div class="row">
            <h2 id="heading" class="pb-2 border-bottom mb-4 text-muted">Today Best Deals</h2>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 mb-5">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <small class="card-text txt-ellipsis text-capitalize text-muted fw-bold"> <?php echo $value['description'];?> </small>
                        <form action="" method="post" class="myForm"> 
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-2">
                                ...
                                <div> 
                                    <input type="hidden" name="product_id" id="myId" value="<?php echo $value['id'];?>">
