<?php
    include('../controller/searched_product_Controller.php');
    $conn = new SearchedProductController();
    ob_start();
    require('header.php');

    // var_dump($_REQUEST['product_Name']);

    $data = $conn->fetch_product_detail($_REQUEST['product_Name']);
    // var_dump($data);
...
?>
    ...
    <div class="container">
        <div class="row">
            <!-- Show All Searched Product -->
            <h2 id="heading" class="pb-2 border-bottom mb-4 text-muted">Searched Product</h2>
