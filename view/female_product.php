<?php 
    include('../controller/femaleProductsController.php');
    require('header.php');
    $conn = new FemaleProductsController();

    // Searching of Product
    if(isset($_REQUEST['search'])) {
        $record = $conn->search_female_allProducts($_REQUEST);
    } else if($conn) {
        $record = $conn->fetch_allFemaleProducts();
    }
    ...
    if(!empty($_REQUEST['add_to_cart'])) {
        if(isset($_SESSION['user_id'])) { 
            ...
            echo "<script>location.href='add_to_cart.php?pageName=femaleProduct&productId=$productid&size=$size&quantity=$quantity&userId=$userId'</script>";
        } else {
    ...
    <div id="carouselExampleControls" class="carousel slide  carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="../slider/1.png" class="d-block w-100" height="520px" alt="https://picsum.photos/1920/500">
            </div>
            <div class="carousel-item">
                <img src="../slider/2.png" class="d-block w-100" height="520px" alt="https://picsum.photos/1920/500">
            </div>
            <div class="carousel-item">
                <img src="../slider/3.png" class="d-block w-100" height="520px" alt="https://picsum.photos/1920/500">
            </div>
        </div>
...
<!--CARD-->
    <div class="container-fluid"> 
        <!-- Female Products -->
        <div class="row">
            <h2 id="heading" class="pb-2 border-bottom mb-4 text-muted" id="female">Female Products</h2>
